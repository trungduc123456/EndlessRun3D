...
public class TrackSegment : MonoBehaviour
{
    ...
    void OnEnable()
    {
		...
		GameObject obj = new GameObject("ObjectRoot"); // Init a gameobject with name: ObjectRoot
		obj.transform.SetParent(transform); // set parent for obj
		objectRoot = obj.transform; // set tranform for objectRoot
	...
	public void Cleanup()
	{
        ...
        //TrackManager.instance.FreeSegment(this.gameObject.GetComponent<TrackSegment>());
		//Destroy(gameObject);
	}
